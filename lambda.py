...
def recommend_portfolio(intent_request):
    ...
    if age >= 65:
        return build_validation_result(
            False,
            "age",
            "You are already past our retirement age.",
            )
    ...
    if investmentAmount < 5000:
        return build_validation_result(
            False,
            "investmentAmount",
            "In order for us to reccomend a portfolio, you must invest a minimum of $5,000.",
            )
...
def get_recommendation(risk_level, intent_request):
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            "content": """We're happy to get you started, {};
            Based on your input, our recommended investment strategy for you is: {}.
